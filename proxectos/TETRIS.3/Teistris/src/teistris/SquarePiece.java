...
public class SquarePiece extends Piece {
    ...
    public SquarePiece(int x, int y, Color fillColor, Game game) {
        ...
        squares[0] = new SquarePiece(Game.MAX_X / 2 - Game.SQUARE_SIDE, 0, Color.BLUE, game);
        squares[1] = new SquarePiece(Game.MAX_X / 2, 0, Color.BLUE, game);
        squares[2] = new SquarePiece(Game.MAX_X / 2 - Game.SQUARE_SIDE, Game.SQUARE_SIDE,
                Color.BLUE, game);
        squares[3] = new SquarePiece(Game.MAX_X / 2, Game.SQUARE_SIDE, Color.BLUE, game);
