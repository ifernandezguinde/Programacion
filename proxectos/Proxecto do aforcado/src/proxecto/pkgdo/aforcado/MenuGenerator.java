...
public class MenuGenerator {
        ...
        while (!hangMan.isGameOver()) {
            ...
            if (inputLetter.isEmpty() || inputLetter.length() > 1) {
                ...
                if (!previousState.equals(currentState)) {
                    System.out.println("Boa! A letra está na palabra.");
                } else {
                    System.out.println("Oops! Esa letra non está.");
                }
            }
        }
    ...
    chámaselle a showInitMenu() para xerar unha palabra aleatoria. Logo, créase
    unha nova instancia de HangMan coa palabra xerada. Despois, chámaselle a
    showGameMenu() para xestionar a partida. Ao rematar cada partida,
    chámaselle a showExitMenu() para preguntar ao xogador se desexa xogar outra
    partida ou saír. O bucle remata cando showExitMenu() devolve true,
    indicando que o xogador escolleu saír do xogo. Finalmente, péchase o recurso
    scan con menuGenerator.scan.close(); para liberar os recursos asociados
    ao obxecto Scanner.
     *
     * @param args
     */
    public static void main(String[] args) {
        ...
        menuGenerator.scan.close(); // Cerrar recurso
    }
}
