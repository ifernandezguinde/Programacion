...
public class WordGenerator {
     ...
     * 0 (inclusive) e o tamaño do array `WORDLIST` (exclusivo). - Seleccionar
     * unha palabra: Utilízase este número aleatorio como índice para acceder a
     * un elemento do array `WORDLIST`. Devolve a palabra naquela posición.      *
     *
     * @return
     */
