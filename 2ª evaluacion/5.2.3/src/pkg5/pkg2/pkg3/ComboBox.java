...
public class ComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        desplegable.setBackground(new java.awt.Color(255, 51, 51));
        desplegable.setEditable(true);
        desplegable.setForeground(new java.awt.Color(0, 0, 0));
        desplegable.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CAN", "GATO", "GALO" }));
    ...
    private void talkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_talkButtonActionPerformed
       ...
       String resposta;
        ...
        if (desplegable.getSelectedItem().equals("CAN")){
            resposta = "GUAU!! ";
            JOptionPane.showMessageDialog(this, resposta);
        }
        
        else if (desplegable.getSelectedItem().equals("GATO")){
            resposta = "MIAU!! ";
            JOptionPane.showMessageDialog(this, resposta);
        }
        
        else if (desplegable.getSelectedItem().equals("GALO")){
            resposta = "KIKIRIKI!! ";
            JOptionPane.showMessageDialog(this, resposta);
        }
        
        else{   
            JOptionPane.showMessageDialog(this, "Erro. debes elixir un can, un "
                    + "gato ou un galo");
        }       
